...
class Layer(Module):
    ...
    def __init__(self, nin, nout, **kwargs):
        ...
        # i = 0, Layer(sz[0]=2, sz[1]=16, nonlin=0!=2), [Neuron(2, nonlin=True) for _ in range(16)]
        # i = 1, Layer(sz[1]=16, sz[2]=16, nonlin=1!=2), [Neuron(16, nonlin=True) for _ in range(16)]
        # i = 2, Layer(sz[2]=16, sz[3]=1, nonlin=2!=2), [Neuron(16, nonlin=False) for _ in range(1)]
...
class MLP(Module):
    ...
    def __init__(self, nin, nouts):
        ...
        # i = 0, Layer(sz[0]=2, sz[1]=16, nonlin=0!=2)
        # i = 1, Layer(sz[1]=16, sz[2]=16, nonlin=1!=2)
        # i = 2, Layer(sz[2]=16, sz[3]=1, nonlin=2!=2)
        self.a = 0
